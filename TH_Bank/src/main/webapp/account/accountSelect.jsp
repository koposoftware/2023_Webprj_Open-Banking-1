...
<div class ="container">
    ...
    <div id ="search-container">
        ...
        <p style=" text-align: right; font-family: 'NanumSquareRound', sans-serif; margin-right: 30px;">총 잔액 <h2 style="text-align: right; font-size:35px; color:#1e3c72; font-family: 'NanumSquareRound', sans-serif "><%= formattedBalance %>원</h2></p>
