...
<style>
 ...
 @import url('https://cdn.rawgit.com/innks/NanumSquareRound/master/nanumsquareround.min.css');
	...
	<body>
        ...
        <div id="main-text">
       	<a href ="Main.jsp">
         <img src="static/img/logo.png" width="70px" style="margin-top: 40%;">
          Bank
       </a>
       </div>
		<%-- <%
		...
		out.println("TH은행 관리자 페이지");
		        %>
		<div class="menu">
			<a href="./manageAdmin.bankadmin" id="menu-button2-1">회원관리</a>
			<a href="./logout.bank" id="menu-button2-2">로그아웃</a>
		</div>
		<%
		} else {
			String message = name + "(" + id + ")" + "님 환영합니다.";
		%>
			<marquee direction=right scrollamount="3"><p id="welcomeMessage"><br><%= message %></p></marquee>
		<div class="menu"> <!-- 버튼 컨테이너로 감싸줍니다. -->
          <a href="./accountSelect.bank" id="menu-button"> 내 정보 </a>
...
<%--          <a href="./transfer.bank" id="menu-button"> 이체 </a>--%>
		...
		<%
			 ...
			 <div class="menu">
                    ...
                    <a href="loginInput.bank" id="menu-button2-1"> 로그인 </a>
              </div>
		<% } %>
	</div>
	</body>
