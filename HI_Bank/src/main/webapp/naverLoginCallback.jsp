...
<html>
  ...
  <body>
	<h1>네이버로그인 성공</h1>
	<%
	// TODO Auto-generated met3hod stub
    String clientId = "864Lu4loF29JO4vp6cBt";//애플리케이션 클라이언트 아이디값";
    String clientSecret = "HJjGxoUS_6";//애플리케이션 클라이언트 시크릿값";
    String code = request.getParameter("code");
    String state = request.getParameter("state");
    String redirectURI = URLEncoder.encode("http://144.24.91.101:8083/naverLoginCallback.jsp", "UTF-8");
    String apiURL;
